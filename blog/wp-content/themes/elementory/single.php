...
<main id="primary" class="site-main">
	...
	while ( have_posts() ) :
		...
		do_action( 'elementory_post_navigation' );

		if ( is_singular( 'post' ) ) {
			$related_posts_label = get_theme_mod( 'elementory_post_related_post_label', __( 'Related Posts', 'elementory' ) );
			...
			if ( $query->have_posts() ) :
				...
				<div class="related-posts">
					<?php if ( get_theme_mod( 'elementory_post_hide_related_posts', false ) === false ) : ?>
	...
	<?php
	if ( elementory_is_sidebar_enabled() ) {
		get_sidebar();
	}
	get_footer();
