...
function add_resources() {
 ...
 wp_enqueue_style( 'custom1', get_template_directory_uri() . '/header-assets/template.css', array(), wp_get_theme()->get( 'Version' ), 'all' );
 wp_enqueue_style( 'custom2', get_template_directory_uri() . '/header-assets/fontello.css', array(), wp_get_theme()->get( 'Version' ), 'all' );
 wp_enqueue_style( 'custom3', get_template_directory_uri() . '/header-assets/responsive.css', array(), wp_get_theme()->get( 'Version' ), 'all' );
 wp_enqueue_style( 'custom4', get_template_directory_uri() . '/header-assets/template.shortcodes.css', array(), wp_get_theme()->get( 'Version' ), 'all' );
...
function breadcrumbs() {
 ...
 echo '<div vocab="http://schema.org/" typeof="BreadcrumbList"><span class="fa fa-home text-black"></span><span  property="itemListElement" typeof="ListItem"><a href="https://nidmm.in/"  property="item" typeof="WebPage"><span property="name">Home</span></a> <meta property="position" content="1"></span> ' . $delimiter . ' ';
